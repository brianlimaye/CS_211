...
/*
 *Function Prototypes that are used throughout the program.
 */
int roll_Dice(void);

void print_board(int player_pos_1, int player_pos_2);
...
void print_board(int player_pos_1, int player_pos_2) {
    ...
    while (i < 24) {
         ...
         */
        pos = fill_main_board(board, player_pos_1, player_pos_2, pos, i);
     ...
     */
    pos = fill_last_slot(board, player_pos_1, player_pos_2, pos, i);
    board[pos] = '\0';
...
int read_seed(char *buffer) {
    ...
    do {
         ...
         *Checks to see if the input is convertible, or is a valid positive integer.
         */
